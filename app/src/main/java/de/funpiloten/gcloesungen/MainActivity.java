...
public class MainActivity extends Activity {
    ...
    private String S1 = "14,1,3,8,4,5,13,23,9,18,4,9,5,5,18,19,20,5,14,22,9,5,18,3,1,3,8,5,19,7,5,6,21,14,4,5,14,8,1," +
             ...
             "30,23,5,9,14,5,14,21,14,4,1,21,3,8,14,21,12,12,16,6,5,18,4,5,14,22,15,18,2,5,9,4,1,6,21,5,18,19,1,8,5,14,23,9,18,1,3,8,20,11,21,5," +
...
NACHDEM WIR DIE ERSTEN VIER CACHES GEFUNDEN HATTEN WAREN WIR FEUER UND FLAMME ES KAMEN NEUN WEITERE HINZU DA WIR SELBST NOCH NULL VERSTECKT HABEN
HABEN WIR NUN DAMIT ANGEFANGEN SO KAMEN WIR AUF DIE IDEE MIT DEM RAETSEL NEUN FREUNDE HABEN ES GEGEN GELESEN UND DREI HABEN ES HERAUSGEFUNDEN DIE
ANDEREN HATTEN NULL AHNUNG WIR HOFFEN DASS WENIGSTENS FUENF WEITERE DEN CACHE FINDEN WERDEN BEIM VERSTECKEN KAMEN WIR AN NULL^ WEINEN UND AUCH NULL
PFERDEN VORBEI DA FUER SAHEN WIR ACHT KUEHE IMMER HIN BEI BAUM NUMMER NULL ACHT HABEN WIR UEBERLEGT DEN CACHE ZU VERSTECKEN SIND DANN ABER DECH
WEITER GELAUFEN DAS LOGBUCH HAT ACHT SEITEN UND WIR HABEN SIEBEN MINUS SECHS STIFTE DA ZU GELEGT
Station1:
49°09.305
8°08.876
